...
export default function ShowLatestProducts(props) {
  ...
  useEffect(() => {
    async function getProducts() {
      try {
        ...
        setProducts(response.data.products.slice(-8));
        setLoading(false);
      } catch (error) {
  ...
  return (
    <>
      ...
      <div className="col-md-12 col-lg-10 col-12 p-2">

              <h1 className="m-0 bg-primary text-white p-3">Latest Sale Products</h1>
